...
public class UserController {
  ...
  public String updateUser(
      @Valid @ModelAttribute("user") UserDto userDto,/* @PathVariable("userId") Long userId,*/
      Model model) {
  ...
  public String saveToWishList(Model model, @PathVariable("speciesName") String speciesName,
      Authentication authentication) {
  ...
  public String addToWishList(Model model, @PathVariable Long sightingId,
      Authentication authentication) {
    User user = userService.findUserByEmail(authentication.getName());
    model.addAttribute("user", user);
    List<Species> wishList = user.getWishList();
